		...
		<>
			...
			<Container
				...
				<Grid container spacing={2}>
							...
							<Grid item sm={6} md={4} lg={3} xs={12}>
								<Box
									...
									<Box sx={{ display: 'flex', alignItems: 'center' }} mb={2}>
										...
										<IconButton
											onClick={() => {
												navigator.clipboard.writeText(notification.address);
											}}>
											<ContentCopyIcon
									...
									<Box
										...
										<Stack spacing={1} direction='row'>
											{notification.email_for_notification &&
												notification.email_for_notification != '' && (
													<Box
														component='img'
														sx={{
											...
											{notification.slack_channel_for_notification &&
												notification.slack_channel_for_notification != '' && (
													<Box
														component='img'
														sx={{
										...
										<Button
											...
											onClick={() => {
												...
												dispatch(updateOpenEditNotificationDialog(true));
											}}>
											Edit
										</Button>
									</Box>
					...
					{planStats?.remaining_notifications > 0 && (
						<Grid item sm={6} md={4} lg={3} xs={12}>
							<Button
								p={2}
								onClick={() => {
									dispatch(updateOpenCreateNotificationDialog(true));
								}}
								sx={{
									width: '100%',
									height: '100%',
