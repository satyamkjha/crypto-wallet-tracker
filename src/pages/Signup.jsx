...
import { Alert, Avatar, Box, Button, Container, Divider, Fab, Grid, IconButton, InputAdornment, Stack, TextField, Typography } from "@mui/material";
...
export default function Signup() {
  ...
  return (
    <Grid container>
      <Grid item xs={6} sx={{ display: { xs: "none", md: "block" } }} backgroundColor="background.neutral">
        <Box sx={{ minHeight: "100vh", display: "flex", flexDirection: "column" }}>
          ...
          <Container maxWidth="sm" sx={{ display: "flex", alignItems: "center", flexGrow: 1 }}>
            <Stack spacing={3}>
          ...
          <Box pb={2} pt={2}>
            <Container maxWidth="sm">
              <Typography variant="body2">Copyright @ 2022 CredShields. All Rights Reserved.</Typography>
            </Container>
          </Box>
        </Box>
      </Grid>
      ...
      <Grid item xs={12} md={6}>
        <Box sx={{ minHeight: "100vh", display: "flex", flexDirection: "column" }}>
          ...
          <Container maxWidth="lg" sx={{ display: "flex", alignItems: "center", flexGrow: 1 }}>
              ...
              >
                ...
                <Form autoComplete="off" noValidate onSubmit={handleSubmit}>
                  <Stack spacing={1}>
                        ...
                        endAdornment: (
                          <InputAdornment position="end">
                            <IconButton edge="end" onClick={() => setShowPassword((prev) => !prev)}>
                              {showPassword ? <VisibilityIcon sx={{ opacity: 0.5 }} /> : <VisibilityOffIcon sx={{ opacity: 0.5 }} />}
                            </IconButton>
                          </InputAdornment>
                        ),
                      }}
                        ...
                        endAdornment: (
                          <InputAdornment position="end">
                            <IconButton edge="end" onClick={() => setShowConfirmPassword((prev) => !prev)}>
                              {showConfirmPassword ? <VisibilityIcon sx={{ opacity: 0.5 }} /> : <VisibilityOffIcon sx={{ opacity: 0.5 }} />}
                            </IconButton>
                          </InputAdornment>
                        ),
                      }}
                    ...
                    <Box pt={1} pb={1}>
                      <Divider sx={{ color: "text.secondary", fontSize: "0.8rem" }}></Divider>
                    </Box>
