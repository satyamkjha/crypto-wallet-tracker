...
export default function PlanContainer() {
	...
	const [SubscriptionExpiredDialogOpen, setSubscriptionExpiredDialogOpen] =
	...
	const payUsingCoinpayments = () => {
		if (currentPlan === updatingPlanTo) {
			...
			dispatch(
				updatePlanUsingCoinpayment({
					targetPlan: updatingPlanTo,
					targetCrypto: selectedCryptoCurrency,
				})
			);
		}
	};
	...
	const [openCoinpaymentDialog, setOpenCoinpaymentDialog] =
		React.useState(false);
	...
	return (
		<>
					...
					{isBilling && (
						<Typography variant='subtitle1'>
							...
							<span style={{ color: 'green' }}>
								...
								{currentPlan === 2 && ' Enterprise'}
								{planStats?.subscription_end &&
									'/' + formatDate(planStats?.subscription_end)}
							</span>
						</Typography>
					)}
				</Box>
						...
						<Stack
							...
							<Stack spacing={2}>
								...
								<Box sx={{ display: 'flex', alignItems: 'center' }}>
									<CheckIcon sx={{ marginRight: 1, fontSize: '1rem' }} />
									<Typography variant='body2'>
										Unlimited Notification Channel for Alerts
									</Typography>
								</Box>
						...
						<Stack
							...
							<Box
								...
								<Button
									variant='outlined'
									color='warning'
									sx={{ backgroundColor: '#332801', border: 'none' }}>
									Best Value
								</Button>
							</Box>
							...
							<Stack spacing={1} sx={{ opacity: 0.8 }}>
								<Box sx={{ display: 'flex', alignItems: 'center' }}>
									<CheckIcon
										sx={{ marginRight: 1, fontSize: '1rem', color: 'White' }}
									/>
								...
								<Box sx={{ display: 'flex', alignItems: 'center' }}>
									...
									/>
									<Typography variant='body2' color='common.white'>
										Unlimited Notification Channel for Alerts with Custom
										Webhooks
									</Typography>
								</Box>
			...
			<Dialog
				open={SubscriptionExpiredDialogOpen}
				onClose={handleSubscriptionExpiredDialogClose}>
				<DialogTitle color='error' variant='h3'>
					Your Subscription is Expired
				</DialogTitle>
				<DialogContent>
					<Typography>
						Your current plan subscription is expired. Please renew your
					...
					<Button
						variant='contained'
						sx={{ marginTop: 2 }}
						onClick={handleSubscriptionExpiredDialogClose}>
						Ok
					</Button>
				</DialogContent>
			</Dialog>
			...
			<Dialog
				...
				onClose={handleCloseCoinpaymentDialog}>
				<DialogTitle textAlign='center'>
					Complete the payment using Coinpayments
				</DialogTitle>
				<DialogContent>
					<Grid container spacing={3}>
						<Grid item xs={12}>
